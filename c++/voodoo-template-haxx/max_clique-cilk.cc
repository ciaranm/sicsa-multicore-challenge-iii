 ...
 *
 * Voodoo haxxed C++ Cilk parallel implementation of the max clique algorithm
 * described in:
 *
 ...
 * Compile like this:
 *
 *     g++-4.9 -O3 -march=native -o max_clique-cilk -std=c++14 -fcilkplus max_clique-cilk.cc
 *
 * Run like this:
 *
 *     ./max_clique-cilk brock200_1.clq
 *
                ...
                ) -> void
        {
            ...
            for (int n = p.popcount() - 1 ; n >= 0 ; --n) {
                ...
                if (new_p.empty())
                    ...
                    cilk_spawn copy_and_expand(c, new_p);
                else
                    expand(c, new_p);
